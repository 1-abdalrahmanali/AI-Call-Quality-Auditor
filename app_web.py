...
def check_password():
    ...
    with col2:
        ...
        # يمكنك تغيير كلمة المرور من هنا بسهولة
...
st.markdown("""
    ...
    /* تعديل كروت الـ Metrics لتكون واضحة وجذابة في الـ Dark Mode */
    ...
    /* ضمان أن العنوان والنتيجة داخل الكارت يكون لونهم واضح */
        ...
        if not SERVER_GROQ_KEY or "حط_المفتاح" in SERVER_GROQ_KEY:
            ...
            with st.spinner("🔄 Processing speech transcription and evaluating compliance rules..."):
                try:
                    ...
                    prompt = f"""
                    You are an expert Senior Quality Assurance (QA) Auditor for multinational English and Spanish customer service operations.
                    Analyze the following call transcript thoroughly based on strict corporate governance rules:

                    Transcript: "{transcript_text}"

                    Use these strict reference lists for policy checks:
                    ...
                    2. Check if the agent used any words from the Offensive lists.
                    3. Check if the agent used any phrases from the Banned lists.
                    4. Detect grammar, syntax, or phrasing errors and provide professional corrections.
                    5. Rate the call out of 10.
